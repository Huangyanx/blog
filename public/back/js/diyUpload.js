...
(function( $ ) {
    ...
    /*选中事件*/
    function checked_img($checked,$obj) {
        $checked.toggle();
        $obj.toggleClass("checked_li");
    }
    ...
    function createBox( $fileInput, file, webUploader ) {
        ...
        var li = '<li id="fileBox_'+file_id+'" class="diyUploadHover"> \
                    <div class="check_img"><img src="public/back/images/checked.png"> </div> \
					<div class="viewThumb">\
					    <input type="hidden">\
					    <div class="diyBar"> \
        ...
        $fileBox.on('click',function(){
            checked_img($(this).find('.check_img'),$(this));
        })
