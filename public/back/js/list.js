...
function si_createlist(data) {
    ...
    str += '<li class="browse-file">'+
        '<div class="filename-col">'+
        '<img class="icon sprite '+icon_style+'" src="img/icon_spacer.gif" />'+
        '<div class="filename">'+data.name+'</div></div>'+
        '<div class="kind">'+data.type+'</div>'+
        '<div class="modified">'+data.lastModifiedDate+'</div>'+
        '<br style="clear:both;" /></li>';
